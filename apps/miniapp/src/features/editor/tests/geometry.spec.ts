...
import { clampPlacement, millimetresToPixels, placementPixelPoint, pixelPointToPlacement, snapPlacement } from '../domain/geometry'
...
describe('DIY editor geometry', () => {
  ...
  it('magnetically snaps close placements to the embroidery center', () => expect(snapPlacement({ ...placement, centerXRatio: .515, centerYRatio: .487 }, pattern, area)).toMatchObject({ centerXRatio: .5, centerYRatio: .5 }))
})
