...
export const useEditorStore = defineStore('editor', () => {
  ...
  function restoreDesign(design: StoredDesign): void { placements.value = design.placements; savedDesign.value = { id: design.id, totalPriceCents: design.totalPriceCents } }
