...
export const useEditorStore = defineStore('editor', () => {
  ...
  return { bag, categories, activeCategoryId, activePatterns, placements, selectedPlacementId, selectedPlacement, patternPriceCents, totalPriceCents, catalogError, loadingCatalog, catalogLoaded, savedDesign, getPattern, addPattern, updatePlacement, selectPlacement, deleteSelected, replaceSelected, clearDraft, loadCatalog, saveDesign }
})
