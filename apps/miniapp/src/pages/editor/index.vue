    ...
    <template v-else>
      ...
      <view class="workbench">
        ...
        <view class="editor-card">
          <view class="canvas-head"><text class="zoom-value">{{ Math.round(canvasZoom * 100) }}%</text></view>
      ...
      <view class="canvas-tools"><view class="tool-actions"><button @tap="updateCanvasZoom(-.1)">−</button><button @tap="updateCanvasZoom(.1)">+</button><view class="tool-divider"/><button :disabled="!editor.selectedPlacement" @tap="editor.undo">撤销</button><button :disabled="!editor.selectedPlacement" @tap="editor.redo">重做</button><button class="danger" :disabled="!editor.selectedPlacement" @tap="editor.deleteSelected">删除</button></view><button class="save-design" :loading="saving" @tap="save">保存设计</button></view>
...
.workbench{display:flex;align-items:stretch;gap:12rpx}.category-rail{width:106rpx;height:514rpx;box-sizing:border-box;display:flex;flex:none;flex-direction:column;gap:7rpx}.category-button{flex:1;min-height:0;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2rpx;padding:4rpx;border:1rpx solid transparent;border-radius:15rpx;background:#f8d6dc;color:#674a4b;font-size:17rpx;line-height:1.15;text-align:center}.category-button:nth-child(2n){background:#dcefd7;color:#476145}.category-button:nth-child(3n){background:#fff0bd;color:#735e31}.category-button:nth-child(4n){background:#d7eafb;color:#486273}.category-button:nth-child(5n){background:#e4dbfa;color:#574b76}.category-button.active{border-color:#ed7b72;box-shadow:inset 0 0 0 2rpx #ed7b72}.icon{font-size:23rpx}.editor-card{min-width:0;flex:1;padding:15rpx 12rpx;border:1rpx solid rgba(255,255,255,.85);border-radius:24rpx;background:#fff;box-shadow:0 10rpx 28rpx rgba(108,75,53,.08)}.canvas-head{display:flex;justify-content:flex-end;align-items:center;padding:0 5rpx 10rpx}.zoom-value{padding:4rpx 10rpx;border-radius:20rpx;background:#f6ebe4;color:#a56447;font-size:18rpx}.canvas-viewport{position:relative;height:448rpx;overflow:hidden;border-radius:17rpx;background:radial-gradient(circle at 50% 42%,#fff 0%,#f8f1ea 75%)}.canvas-scene{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;transform-origin:center;will-change:transform}.stage{position:relative;width:94%;overflow:hidden;border-radius:12rpx;background:#fff;box-shadow:0 8rpx 19rpx rgba(81,53,38,.12)}.bag{position:absolute;inset:0;width:100%;height:100%}.embroidery-zone{position:absolute;overflow:hidden;border:2rpx dashed #9d6043;touch-action:none}.canvas-empty{position:absolute;left:50%;top:50%;padding:8rpx 10rpx;transform:translate(-50%,-50%);border-radius:20rpx;background:rgba(255,255,255,.8);color:#9b7562;font-size:17rpx;white-space:nowrap}.placed{position:absolute;left:0;top:0;touch-action:none;will-change:transform}.placed image{width:100%;height:100%}.selected{outline:2rpx solid #f06e6a;outline-offset:3rpx}.rotate-handle{position:absolute;left:50%;top:-38rpx;width:36rpx;height:36rpx;transform:translateX(-50%);border-radius:50%;display:flex;align-items:center;justify-content:center;background:#4b85ec;color:#fff;font-size:25rpx;box-shadow:0 3rpx 8rpx rgba(46,101,192,.28)}
.canvas-tools{display:flex;flex-direction:column;gap:10rpx;margin-top:12rpx;padding:12rpx;border-radius:18rpx;background:#fff;box-shadow:0 8rpx 21rpx rgba(108,75,53,.06)}.tool-actions{display:flex;align-items:center;justify-content:center;gap:8rpx}.canvas-tools button{min-width:57rpx;margin:0;padding:0 13rpx;border:1rpx solid #eaded5;border-radius:13rpx;background:#fff;color:#5d4640;font-size:20rpx;line-height:58rpx}.canvas-tools button[disabled]{opacity:.38}.canvas-tools .danger{color:#c85a50}.tool-divider{width:1rpx;height:34rpx;background:#eee4de;margin:0 2rpx}.canvas-tools .save-design{width:100%;border-color:#b46b4a;background:#b46b4a;color:#fff;font-weight:700}.price-summary{display:flex;align-items:center;justify-content:space-between;margin-top:12rpx;padding:0 10rpx}.price-items{display:flex;gap:13rpx;color:#806c62;font-size:20rpx}.total{display:flex;flex-direction:column;align-items:flex-end;gap:1rpx;color:#bb5947;font-size:18rpx}.total text:last-child{font-size:29rpx;font-weight:800}
